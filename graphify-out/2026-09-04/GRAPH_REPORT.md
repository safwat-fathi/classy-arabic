...
## Corpus Check
- 320 files · ~418,758 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1795 nodes · 3841 edges · 156 communities (141 shown, 15 thin omitted)
...
Cohesion: 0.06
Nodes (67): CartItemNotFoundError, Exception, line_item_id does not reference an existing cart item for this conversation's…, _ActionBase, AddToCartAction, CreateOrderAction, GetCheckoutStateAction, GetDeliveryInfoAction (+59 more)

### Community 1 - "channels/router.py"
Cohesion: 0.17
Nodes (18): ArqRedis, AsyncSession, get, post, receive_meta_webhook(), receive_twilio_webhook(), verify_meta_webhook(), parse_twilio_payload() (+10 more)

### Community 2 - "app/models/__init__.py"
Cohesion: 0.10
Nodes (42): ConversationNotFoundError, create_manual_order(), ProductNotFoundError, AsyncSession, Exception, AsyncSession, Decimal, Single, service-owned writer for `Order`/`OrderItem` rows. `status` and… (+34 more)

### Community 3 - "Product"
Cohesion: 0.15
Nodes (40): add_item(), _get_item_for_conversation(), _get_or_create_active_cart(), AsyncSession, remove_item(), update_item(), create_order(), get_checkout_state() (+32 more)
...
Cohesion: 0.12
Nodes (39): Real delivery-area lookup (SRD §29). A merchant with no configured active areas…, validate_delivery_area(), delete_delivery_area_endpoint(), get_delivery_areas(), patch_delivery_area(), post_delivery_area(), AsyncSession, delete (+31 more)
...
Cohesion: 0.08
Nodes (26): asyncio, do_run_migrations(), Run migrations in 'offline' mode. This configures the context with just a URL…, In this scenario we need to create an Engine and associate a connection with…, Run migrations in 'online' mode., run_async_migrations(), run_migrations_offline(), run_migrations_online() (+18 more)
...
Cohesion: 0.07
Nodes (56): checkResponse(), ConversationRecord, createKnowledgeAction(), createManualOrderAction(), createProductAction(), deleteKnowledgeAction(), deleteProductAction(), fetchConversationsAction() (+48 more)

### Community 11 - "process_message"
Cohesion: 0.24
Nodes (28): _correction_count(), _known_intents(), _merchant_info(), process_message(), AsyncSession, _chat_response(), _embedding_response(), _inbound_message() (+20 more)
...
Cohesion: 0.21
Nodes (18): AsyncOpenAI, AICallError, get_deepseek_client(), get_embedding_client(), parse_json_content(), Exception, Model call failed or returned unusable content., §7's observability requirement: log token counts + latency for every AI call,… (+10 more)
...
Cohesion: 0.27
Nodes (12): extract_order(), build_system_prompt(), ConvState, _chat_response(), test_extract_order_flags_ambiguous_fields(), test_extract_order_returns_result_when_clean(), test_extract_order_skips_ai_call_on_repeated_correction(), test_build_system_prompt_accepts_action_task_block() (+4 more)

### Community 17 - "get_db"
Cohesion: 0.19
Nodes (16): get_db(), Dependency function that yields a database session., MerchantStatus, _mock_facebook_success(), mock, test_facebook_callback_creates_merchant_and_returns_token(), test_facebook_callback_rejects_invalid_facebook_token(), test_facebook_callback_rejects_suspended_merchant() (+8 more)
...
Cohesion: 0.16
Nodes (22): get_current_merchant(), AsyncSession, HTTPAuthorizationCredentials, _bearer(), HTTPAuthorizationCredentials, test_get_current_merchant_dev_bypass_returns_merchant_when_configured_and_no_token(), test_get_current_merchant_invalid_token_raises_401(), test_get_current_merchant_missing_token_raises_401() (+14 more)
...
Cohesion: 0.24
Nodes (7): build_context_prompt(), test_raw_message(), FakeExample, FakeMessage, test_build_context_prompt_includes_examples(), test_build_context_prompt_includes_history_and_current(), test_build_context_prompt_action_mode_runs()
...
Cohesion: 0.24
Nodes (11): match_tier0(), main(), Manual evaluation runner — NOT part of `make test` / CI. Hits the real…, run_case(), test_bare_link_is_spam(), test_greeting_matches(), test_normal_message_has_no_match(), test_product_link_with_long_sentence_is_not_spam() (+3 more)
...
### Community 28 - "message.py"
Cohesion: 0.22
Nodes (13): AbstractAsyncContextManager, Direction, _compose_reply(), _process_channel_message(), AsyncSession, Conversation, Build a human-readable reply from the pipeline result., Send a reply via the channel and persist the outbound message. (+5 more)
...
Cohesion: 0.13
Nodes (22): FacebookIdentity, FacebookPage, fetch_user_pages(), Fetch the Facebook Pages managed by this user. Each page comes with a page-…, facebook_callback(), get_me(), MeResponse, AsyncSession (+14 more)
...
Cohesion: 0.10
Nodes (18): loginWithFacebookAction(), logoutAction(), setAuthCookies(), LoginPage(), MerchantDashboard(), navigation, SidebarClient(), OnboardingPage() (+10 more)
...
### Community 98 - "Conversation"
Cohesion: 0.19
Nodes (16): cluster_messages(), fetch_embedded_messages(), label_cluster(), AsyncSession, representative_messages(), run_clustering(), Conversation, Base (+8 more)
...
### Community 107 - "HumanHandoff"
Cohesion: 0.18
Nodes (17): AsyncSession, post, return_to_ai(), takeover_conversation(), HandoffReturnRequest, HandoffTakeoverRequest, BaseModel, ConversationNotFoundError (+9 more)
...
Cohesion: 0.13
Nodes (38): check_product_belongs_to_merchant(), check_product_exists(), _check_product_ownership(), check_variant_belongs_to_product(), check_variant_exists(), check_variant_is_active(), _check_variant_ownership(), evaluate_action() (+30 more)
...
### Community 129 - "Cart"
Cohesion: 0.21
Nodes (15): _get_active_cart_items(), AsyncSession, Product, ProductVariant, Cart, CartItem, Base, Base (+7 more)

### Community 130 - "test_meta.py"
Cohesion: 0.29
Nodes (15): parse_meta_payload(), verify_meta_signature(), _messenger_payload(), _sign(), test_parse_meta_payload_drops_echo_messages(), test_parse_meta_payload_drops_non_text_messages(), test_parse_meta_payload_extracts_messenger_text_message(), test_parse_meta_payload_handles_multiple_entries_and_messages_in_one_batch() (+7 more)

### Community 131 - "Merchant"
Cohesion: 0.24
Nodes (6): Merchant, Base, test_search_products_scoped_to_merchant(), test_list_products_returns_only_merchant_scoped_products(), test_merchant_facebook_user_id_allows_multiple_nulls(), test_merchant_facebook_user_id_unique_constraint()
...
### Community 138 - "ChannelConnection"
Cohesion: 0.23
Nodes (7): ChannelConnection, Base, Channel, Base, WebhookEvent, test_channel_connection_defaults(), test_webhook_event_stores_raw_payload()
...
### Community 142 - "ingest_channel_message"
Cohesion: 0.45
Nodes (9): ParsedInboundMessage, _find_channel_connection(), _find_or_create_conversation(), ingest_channel_message(), AsyncSession, test_ingest_creates_conversation_and_message(), test_ingest_drops_messages_for_unmapped_account(), test_ingest_is_idempotent_on_duplicate_external_message_id() (+1 more)
...
Cohesion: 0.38
Nodes (5): estimate_cost(), Per-model cost-per-1k-tokens rate table. Empty by default — estimate_cost…, CallUsage, PipelineResult, _usage_event()
...
- **Why does `Merchant` connect `Merchant` to `app/models/__init__.py`, `Product`, `test_product_matching.py`, `DeliveryArea`, `resolve_action`, `LabeledExample`, `ChannelConnection`, `handoff/test_router.py`, `StoreKnowledge`, `ingest_message`, `new_id`, `get_db`, `get_current_merchant`, `conversations/router.py`, `auth/router.py`, `products/router.py`, `Conversation`, `conftest.py`, `HumanHandoff`, `ProductVariant`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `Product` connect `Product` to `ActionArgumentError`, `Cart`, `app/models/__init__.py`, `Merchant`, `Conversation`, `test_product_matching.py`, `resolve_action`, `process_message`, `ProductVariant`, `new_id`, `get_current_merchant`, `products/router.py`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `Channel` connect `ChannelConnection` to `channels/router.py`, `app/models/__init__.py`, `test_meta.py`, `conftest.py`, `ingest_channel_message`, `new_id`, `channels/test_router.py`, `conversations/router.py`, `message.py`?**

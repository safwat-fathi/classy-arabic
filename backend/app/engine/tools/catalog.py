...
async def handle_search_products(
    session: AsyncSession, action: SearchProductsAction, merchant_id: str, conversation_id: str, message_id: str
) -> dict:
...
async def handle_get_product(
    session: AsyncSession, action: GetProductAction, merchant_id: str, conversation_id: str, message_id: str
) -> dict:

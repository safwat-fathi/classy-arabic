...
down_revision: Union[str, Sequence[str], None] = '59f0a9f00cb5'
...
def upgrade() -> None:
    ...
    op.add_column('orders', sa.Column('source', sa.Enum('AI_EXTRACTION', 'CART_CHECKOUT', name='ordersource'), server_default='AI_EXTRACTION', nullable=False))
